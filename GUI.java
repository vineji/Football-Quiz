    ...
    public Quiz(PrintStream ps, InputStream is) {
        ...
        button1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                showResult(isCorrectAnswer(button1)); // everytime the button is pressed it checks whether the answer
            }                                          // on that button is correct
        });

        button2.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                showResult(isCorrectAnswer(button2));
            }
        });

        button3.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                showResult(isCorrectAnswer(button3));
            }
        });

        button4.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                showResult(isCorrectAnswer(button4));
            }
        });
